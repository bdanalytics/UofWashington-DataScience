...
title: "Kaggle Facial Points Detection: Univ of Montreal: left_eye_center classification:: Faces_patch_clssfr"
author: "bdanalytics"
...
#     ,"Image.pxl.1.dgt.1"
    ,"ImageId","left_eye_center_x.int","left_eye_center_y.int","x","y","patch.cor","patch.cor.cut.fctr"
                    ) 
...
#chkObsOOBFP <- subset(chkObsOOB, label.fctr.All.X..rcv.glmnet == "left_eye_center") %>% dplyr::mutate(Probability1 = label.fctr.All.X..rcv.glmnet.prob) %>% select(-.src, -.pos, -x, -y) ", ".pos", "x", "y")) %>% lclgetfltout_df()
#
