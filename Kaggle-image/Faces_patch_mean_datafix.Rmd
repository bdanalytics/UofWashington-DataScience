...
title: "Kaggle Facial Points Detection: Univ of Montreal: left_eye_center_x regression:: Faces_patch_mean_datafix"
author: "bdanalytics"
...
```{r extract.features.image, cache=FALSE, echo=TRUE, eval=myevlChunk(glbChunks, glbOut$pfx)}
